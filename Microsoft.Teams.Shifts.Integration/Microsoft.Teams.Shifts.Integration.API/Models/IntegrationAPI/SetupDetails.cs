...
namespace Microsoft.Teams.Shifts.Integration.API.Models.IntegrationAPI
{
    ...
    public class SetupDetails
    {
        ...
        /// <summary>
        /// Gets or sets the Apigee Authentication API Endpoint.
        /// </summary>
        public string WfmAuthEndpoint { get; set; }

        /// <summary>
        /// Gets or sets the Apigee Authentication API Token.
        /// </summary>
        public string WfmAuthEndpointToken { get; set; }

        /// <summary>
        /// Gets or sets the SOAP Environment based on configuration.
        /// </summary>
        public string SoapEnvOpen { get; set; }
        /// <summary>
