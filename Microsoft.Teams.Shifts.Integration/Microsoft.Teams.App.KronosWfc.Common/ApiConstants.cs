...
namespace Microsoft.Teams.App.KronosWfc.Common
{
    ...
    public static class ApiConstants
    {
        ...
        /// </summary>
        public static string SoapEnvOpen = @"<soapenv:Envelope xmlns:soapenv=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:hs=""http://localhost/wfc/XMLAPISchema"" ><soapenv:Body><hs:KronosWFC><Kronos_WFC version = ""1.0"" Target =""USA"">";
